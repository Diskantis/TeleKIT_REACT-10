...
import { getOneUser, useLazyGetOneUserQuery } from "../../app/services/userApi";
...
export default function FullFeaturedCrudGrid() {
  ...
  const handleEditClick = (id) => () => {
    ...
    // const user = rows.map((row) => row.id === id);
  ...
  const columns = [
    ...
    { field: "surName", headerName: "Отчество", width: 180, editable: true },
    {
      field: "id",
      headerName: "ID",
      type: "number",
